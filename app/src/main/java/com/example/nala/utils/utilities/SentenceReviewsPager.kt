...
class SentenceReviewsPager @Inject constructor(
    private val reviewRepository: ReviewRepository,
) : KeysetPager<Date?, SentenceReviewCache>{
    ...
    override suspend fun getNextResult(): Flow<PagerResult<Date?, SentenceReviewCache>> {
        return reviewRepository.getSentenceReviewsPaged(this.nextKey, this.limit).mapLatest {
